        ...
        <div className='relative max-w-[1240px] w-full h-full flex flex-col mx-auto p-2 flex justify-center items-center'>
          <div>
            ...
            <p className='py-4 text-gray-600 max-w-[70%] m-auto'>
              My purpose as a Front-End developer is to create effective and user-friendly websites that satisfy everyone&apos;s needs.
            </p>
          ...
          <div className="absolute bottom-16">
            ...
            >
              <SlArrowDown size={35} className="animate-bounce" style={{ cursor: 'pointer' }} />
            </AnchorLink>
          </div>
        </div>
      </div>
